...
class Main(object):
	...
	def __init__(self, root_):
		...
		self.title_facts.grid(
			sticky="W", row=2, column=3, columnspan=2, pady=10
		)
		...
		self.fact2_input.grid(
			row=4, column=1, sticky="W", padx=10, pady=1
		)
		...
		# 	sticky="W", row=6, column=1, columnspan=2, padx=10, pady=3
		# )
		#
		...
		# 	row=7, column=1, columnspan=2, padx=10, pady=7
		# )
		#
	...
	# 		label="Abrir", underline=1, command=self.open_file
	# 	)
